...
public class DinoGameScreen extends Screen {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.drawCenteredString(this.font, "🦖 DINO GAME", centerX, phoneY + 18, 0xFFD4AF37);
        guiGraphics.drawCenteredString(this.font, "Скоро...", centerX, phoneY + 100, 0x888888);
